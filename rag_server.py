...
def ingest_document(file_path: str) -> str:
    ...
    try:
        ...
        embeddings = GoogleGenerativeAIEmbeddings(model="models/embedding-001", google_api_key="AIzaSyCbSWI26wv5-93DjystyU_H-Ca-MOxzjIw")
...
def query_rag_store(query: str) -> str:
    ...
    try:
        ...
        embeddings = GoogleGenerativeAIEmbeddings(
            ...
            google_api_key="AIzaSyCbSWI26wv5-93DjystyU_H-Ca-MOxzjIw"
        )
